      ...
      <div class="sideBar_wrapper">
        ...
        <div className="sidebar_container">
          <div className="sidebar_item">
            ...
            <div className="sidebar_text"><Link to="/dashboard">Dashboard</Link> </div>
          </div>
          <div className="sidebar_item">
            <div className="sidebar_icon">{icons.clients}</div>
            <div className="sidebar_text"><Link to="/clients">Client</Link> </div>
          </div>
          <div className="sidebar_item">
            <div className="sidebar_icon">{icons.invoice}</div>
            <div className="sidebar_text"><Link to="/invoices">Invoice</Link> </div>
          </div>
          <div className="sidebar_item">
            <div className="sidebar_icon">{icons.payments}</div>
            <div className="sidebar_text"><Link to="/payments"> Payments</Link></div>
          </div>
          <div className="sidebar_item">
            <div className="sidebar_icon">{icons.products}</div>
            <div className="sidebar_text"><Link to="/products">Products</Link> </div>
          </div>
          <div className="sidebar_item">
            <div className="sidebar_icon">{icons.reports}</div>
            <div className="sidebar_text"><Link to="#">Reports</Link> </div>
          </div>
          <div className="sidebar_item">
            <div className="sidebar_icon">{icons.settings}</div>
            <div className="sidebar_text"><Link to="#">Settings</Link> </div>
